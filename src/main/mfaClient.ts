...
export default class MfaClient {
  ...
  private readonly emailCredentialUrl: string
  private readonly emailCredentialVerifyUrl: string
  private readonly passwordlessVerifyUrl: string
  private readonly phoneNumberCredentialUrl: string
  private readonly phoneNumberCredentialVerifyUrl: string
  private readonly stepUpUrl: string
